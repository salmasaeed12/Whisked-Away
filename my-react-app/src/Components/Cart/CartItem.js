...
const CartItem = ({ item }) => {
  const [show, handleClose, handleShow, handleDeleteItem, itemCount, onChangeCount, handleUpdateCart] = DeleteCartHook(item);
  ...
  return (
    <Col xs="12" className="cart-item-body my-2 d-flex px-2">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body><div className='font'>هل أنت متأكد من حذف المنتج من العربة؟</div></Modal.Body>
        <Modal.Footer>
      ...
      <div className="w-100">
        ...
        <Row className="justify-content-between">
          <Col sm="12" className=" d-flex flex-row justify-content-between">
            ...
            <div className="d-inline pt-2 brand-text">{item.price || 0} جنيه</div>
          </Col>
        </Row>
      </div>
    </Col>
